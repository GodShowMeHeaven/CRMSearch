...
def handle_webhook():
    ...
    prompt = (
        ...
        f"Алгоритм действий:\n"
        f"1. Найди в указанных источниках топ-5 компаний, полностью совпадающих по названию '{company_name}', зарегистрированных в Москве.\n"
        ...
        f"3. Приведи по 5 ссылок, которые могут относиться к этим компаниям из поисковой выдачи, например сайты компаний и т.п.\n\n"
